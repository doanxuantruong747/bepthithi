            ...
            {NavData?.map((item, index) => {
              return (
                <div
                  ...
                  className={`px-[15px] text-md mx-1 cursor-pointer animation-hover inline-block relative font-semibold hover:text-[#84B213]
                   ${activeLink === item.to
                      ? "text-[#84B213]"
                      : ""
                    }`}
                ...
                {NavData?.map((item, index) => {
                  return (
                    <a key={`link-responsive-${index}`} href={item.to}>
                      {/* {t('narbar.aboutExpertT')} */}
                      <p
                        className={
                          `text-md px-4 py-2 mx-2 my-4 cursor-pointer inline-block relative font-bold  text-[#000] hover:text-[#84B213] 
                          ${activeLink === item.to
                            ? "text-[#84B213]"
                            : ""
                          }`
